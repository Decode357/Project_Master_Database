...
<div x-show="DeleteUserModal" x-transition.opacity
    ...
    <div x-show="DeleteUserModal" x-transition
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <button @click="DeleteUserModal = false" class="text-gray-400 dark:text-gray-500 hoverScale hover:text-gray-700 dark:hover:text-gray-300 rounded-full p-2">
                <span class="material-symbols-outlined">close</span>
            </button>
        </div>
        <hr class="mb-4 border-gray-200 dark:border-gray-600">
        <p class="text-gray-700 dark:text-gray-300 mb-6">
            Are you sure you want to delete <span class="font-semibold text-gray-900 dark:text-gray-100" x-text="userNameToDelete"></span>?
        </p>
