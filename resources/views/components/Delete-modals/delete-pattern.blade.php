...
<div x-show="DeletePatternModal" x-transition.opacity
    ...
    <div x-show="DeletePatternModal" x-transition
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <button @click="DeletePatternModal = false" class="text-gray-400 dark:text-gray-500 hoverScale hover:text-gray-700 dark:hover:text-gray-300 rounded-full p-2">
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="button" @click="$event.target.disabled = true; deletePattern()"
