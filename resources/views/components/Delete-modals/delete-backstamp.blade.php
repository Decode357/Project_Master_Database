<!-- Delete backstamp Modal -->
<div x-show="DeleteBackstampModal" x-transition.opacity
    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
    @click.self="DeleteBackstampModal = false" style="display: none;">
    <div x-show="DeleteBackstampModal" x-transition
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <button @click="DeleteBackstampModal = false" class="text-gray-400 dark:text-gray-500 hoverScale hover:text-gray-700 dark:hover:text-gray-300 rounded-full p-2">
        ...
        <div class="flex justify-end gap-3">
            <button @click="DeleteBackstampModal = false"
            ...
            <button type="button" @click="$event.target.disabled = true; deleteBackstamp()"
