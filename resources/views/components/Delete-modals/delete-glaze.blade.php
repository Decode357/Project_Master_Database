<!-- Delete glaze Modal -->
<div x-show="DeleteGlazeModal" x-transition.opacity
    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
    @click.self="DeleteGlazeModal = false" style="display: none;">
    <div x-show="DeleteGlazeModal" x-transition
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <button @click="DeleteGlazeModal = false" class="text-gray-400 dark:text-gray-500 hoverScale hover:text-gray-700 dark:hover:text-gray-300 rounded-full p-2">
        ...
        <div class="flex justify-end gap-3">
            <button @click="DeleteGlazeModal = false"
            ...
            <button type="button" @click="$event.target.disabled = true; deleteGlaze()"
