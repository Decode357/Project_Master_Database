<!-- Delete Shape Modal -->
<div x-show="DeleteShapeModal" x-transition.opacity
    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
    @click.self="DeleteShapeModal = false" style="display: none;">
    <div x-show="DeleteShapeModal" x-transition
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <button @click="DeleteShapeModal = false" class="text-gray-400 dark:text-gray-500 hoverScale hover:text-gray-700 dark:hover:text-gray-300 rounded-full p-2">
        ...
        <div class="flex justify-end gap-3">
            <button @click="DeleteShapeModal = false"
            ...
            <button type="button" @click="$event.target.disabled = true; deleteShape()"
