<!-- Delete color Modal -->
<div x-show="DeleteColorModal" x-transition.opacity
    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
    @click.self="DeleteColorModal = false" style="display: none;">
    <div x-show="DeleteColorModal" x-transition
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <button @click="DeleteColorModal = false" class="text-gray-400 dark:text-gray-500 hoverScale hover:text-gray-700 dark:hover:text-gray-300 rounded-full p-2">
