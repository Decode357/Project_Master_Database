...
<div x-show="DeleteProductModal" x-transition.opacity
    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
    @click.self="DeleteProductModal = false" style="display: none;">
    <div x-show="DeleteProductModal" x-transition
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <button @click="DeleteProductModal = false" class="text-gray-400 hoverScale hover:text-gray-700 rounded-full p-2">
        ...
        <div class="flex justify-end gap-3">
            <button @click="DeleteProductModal = false"
                class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hoverScale hover:bg-gray-300">
                Cancel
            </button>
            <form :action="`/product/${productIdToDelete}`" method="POST">
                @csrf
                @method('DELETE')
