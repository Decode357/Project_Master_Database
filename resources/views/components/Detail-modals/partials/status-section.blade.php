...
<template x-if="{{ $item }}?.status || {{ $item }}?.process">
    <div class="mt-2 flex justify-center items-center gap-6 border border-gray-200 dark:border-gray-600 rounded-lg p-2">
        <!-- Status -->
