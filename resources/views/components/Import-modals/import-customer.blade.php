    ...
    <div class="relative top-20 mx-auto p-5 w-11/12 max-w-2xl shadow-lg rounded-md bg-white dark:bg-gray-800">
        ...
        <div class="flex justify-between items-center pb-3 border-b dark:border-gray-700">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">
                <i class="fas fa-file-import mr-2"></i>Customer Data Import
            </h3>
        ...
        <div class="mt-4">
            ...
            @if(session('import_errors') && is_array(session('import_errors')))
                <div class="mb-4 p-4 bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300 rounded-md max-h-60 overflow-y-auto">
                    <h4 class="font-bold mb-2"><i class="fas fa-list mr-2"></i>รายละเอียดข้อผิดพลาด:</h4>
            ...
            <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <h4 class="text-lg font-medium text-gray-800 dark:text-gray-100 mb-2">
                    <i class="fas fa-step-forward mr-2"></i>Step 1: Get the Template
                </h4>
            ...
            <div class="mb-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <h4 class="text-lg font-medium text-gray-800 dark:text-gray-100 mb-2">
                    <i class="fas fa-step-forward mr-2"></i>Step 2: Upload Your File
                </h4>
                        ...
                        <div class="flex space-y-2 flex-row items-center gap-4">
                            <label class="inline-block px-4 py-2 bg-blue-600 text-white rounded-md cursor-pointer hoverScale hover:bg-blue-700 transition dark:bg-blue-500 dark:hover:bg-blue-600">
                                ...
                                <input 
                                    ...
                                    required 
                                    class="hidden" 
                                    onchange="document.getElementById('selectedFileName').textContent = this.files.length ? this.files[0].name : 'No file selected';"
                                />
                            </label>
                            <p id="selectedFileName" class="text-sm text-gray-600 dark:text-gray-300">No file selected</p>
                        </div>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">
                            <i class="fas fa-info-circle mr-1"></i>Supported formats: CSV, XLSX, XLS (Max 10MB)
                        </p>
                    </div>
            ...
            <div class="p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
                ...
                <ul class="text-xs text-blue-700 dark:text-blue-300 space-y-1 list-disc list-inside">
                    ...
                    <li>Code is <strong>required</strong>, other fields are optional</li>
                    <li>Duplicate codes will update existing records</li>
                    <li>All rows must be valid before import</li>
                </ul>
            </div>
        </div>
    </div>
...
@if(session('error') || session('import_errors') || session('success'))
