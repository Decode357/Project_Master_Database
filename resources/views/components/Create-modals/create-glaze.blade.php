...
<div id="CreateGlazeModal" x-show="CreateGlazeModal" x-transition.opacity
    ...
    <div x-data="glazeModal()" class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-2xl p-6 overflow-y-auto max-h-[90vh]">
        ...
        <form @submit.prevent="submitGlazeForm($event)" class="space-y-4">
            @csrf
            ...
            <div class="flex justify-end gap-2 mt-4">
                <button type="button" @click="CreateGlazeModal = false; errors = {}; newImages = []"
