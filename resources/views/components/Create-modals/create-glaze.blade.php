<div id="CreateGlazeModal" 
    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 overflow-y-auto max-h-[90vh]">
        ...
        <form @submit.prevent="submitGlazeForm" class="space-y-4" 
              x-data="{
                  errors: {},
                  loading: false
              }">
            ...
            <div>
                ...
                <input name="glaze_code" type="text" placeholder="Enter glaze code"
                    ...
                    required />
                <p x-show="errors.glaze_code" x-text="Array.isArray(errors.glaze_code) ? errors.glaze_code[0] : errors.glaze_code" class="text-red-500 text-xs mt-1"></p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <p x-show="errors.glaze_inside_id" x-text="errors.glaze_inside_id ? (Array.isArray(errors.glaze_inside_id) ? errors.glaze_inside_id[0] : errors.glaze_inside_id) : ''" class="text-red-500 text-xs mt-1"></p>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700">Glaze Outer</label>
                    <select name="glaze_outer_id" 
                    ...
                    <p x-show="errors.glaze_outer_id" x-text="errors.glaze_outer_id ? (Array.isArray(errors.glaze_outer_id) ? errors.glaze_outer_id[0] : errors.glaze_outer_id) : ''" class="text-red-500 text-xs mt-1"></p>
                </div>
                ...
                <div>
                    ...
                    <p x-show="errors.effect_id" x-text="errors.effect_id ? (Array.isArray(errors.effect_id) ? errors.effect_id[0] : errors.effect_id) : ''" class="text-red-500 text-xs mt-1"></p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input name="fire_temp" type="number" placeholder="Enter temperature"
                        ...
                        class="mt-1 w-full border rounded-md px-3 py-2 
                               focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
                    <p x-show="errors.fire_temp" x-text="errors.fire_temp ? (Array.isArray(errors.fire_temp) ? errors.fire_temp[0] : errors.fire_temp) : ''" class="text-red-500 text-xs mt-1"></p>
                </div>
            </div>
