...
<div id="CreatePatternModal" x-show="CreatePatternModal" x-transition.opacity
    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" style="display: none;">

    <div x-data="patternModal()" class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-2xl p-6 overflow-y-auto max-h-[90vh]">
        ...
        <form @submit.prevent="submitPatternForm($event)" class="space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <p x-show="errors.pattern_code"
                        x-text="Array.isArray(errors.pattern_code) ? errors.pattern_code[0] : errors.pattern_code"
                ...
                <div>
                    ...
                    <p x-show="errors.pattern_name"
                        x-text="Array.isArray(errors.pattern_name) ? errors.pattern_name[0] : errors.pattern_name"
                        class="text-red-500 dark:text-red-400 text-xs mt-1"></p>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-2 mt-4">
                <button type="button" @click="CreatePatternModal = false; errors = {}; newImages = []"
