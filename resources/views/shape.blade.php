        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-3">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-2 flex justify-end items-center gap-4">
                    <button @click="CreateShapeModal = true"
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($shapes as $shape)
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">{{ $shape->item_code }}</td>
                                <td class="px-6 py-4 whitespace-nowrap">{{ $shape->item_description_thai }}</td>
                                <td class="px-6 py-4 whitespace-nowrap">{{ $shape->item_description_eng }}</td>
