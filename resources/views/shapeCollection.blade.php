            ...
            <form method="GET" action="{{ route('shape.collection.index') }}" class="flex flex-wrap items-end gap-4">
                ...
                <div class="flex-1 min-w-64">
                    <div class="relative">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="{{ __('content.search_by') }}{{ __('content.collection_code') }},{{__('content.collection_name')}}{{ __('content.etc') }}"
